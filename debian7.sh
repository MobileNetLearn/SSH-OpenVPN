...
# konfigurasi openvpn
cd /etc/openvpn/
wget -O /etc/openvpn/client.ovpn "https://raw.githubusercontent.com/Room18/SSH-OpenVPN/master/API/client-1194.conf"
...
# bannerssh
wget https://raw.githubusercontent.com/Room18/SSH-OpenVPN/master/Api/bannerssh
